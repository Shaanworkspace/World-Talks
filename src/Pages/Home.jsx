        ...
        <main className=' w-full flex items-center justify-center  '>
            <div className='mt-16 md:h-76 w-8/10 flex flex-col md:flex-row gap-4'>
                <div className="order-2 mt-5 md:order-1 md:w-1/2 flex flex-col justify-center h-full ">
                    ...
                    <p className=' w-full mb-3 md:w-9/10'>Discover the history. culture. and Of every nation. Sort. search. and filter through countries to find the details you need</p>
